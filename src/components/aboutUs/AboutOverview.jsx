      ...
      <Container size={"lg"}>
        ...
        <div>
          <Responsive.Flex
            ...
            wrap={false}
          >
            <h3 className="headingThree text-primary font-bold flex-1 ">
                ...
                {aboutStatsThree.map((items, index) => {
                  return (
                    <AboutStatCard
                      ...
                      childClassOne={"text-end"}
                      childClassTwo={"text-end"}
                    />
                  );
                })}
              </Responsive.Flex>
        ...
        <div className="mt-[120px] mb-[60px]">
          <div className="   flex  justify-between  lg:border-t-2 lg:border-primary relative ">
            <span className="absolute top-[-11.1px] left-[-12px]  text-[20px] hidden lg:block">
              {triangleRight}
            </span>
            <span className="absolute top-[-11.1px]  right-[-12px] text-[20px]  hidden lg:block">
              {triangleLeft}
            </span>
            <div className="bg-primary h-full w-[2px] bg-primary absolute top-0 left-1/2 -translate-x-1/2 hidden lg:block"></div>
            <div className="py-[60px] space-y-[25px]">
            ...
            <div className="py-[60px] space-y-[25px]">
              <h5 className="headingFive text-primary font-bold text-end">
                Our Vision
              </h5>
              <p className="font-normal text-tarnary para-lg text-end  max-w-[643px] ">
                Enterprise partnerships, built on clarity and craft, are the
                foundation of sustainable growth and long term success. By
                aligning strategic goals & thoughtful executions can create
                meaningful collaborations that drives innovation & measurable

          ...
          <Responsive.Grid gap="xl" cols={{ base: 1, lg: 2 }}>
            <div className="">
              <h3 className="headingThree text-primary font-bold underline">
                {serviceItems?.heroTitle
                  ? serviceItems?.heroTitle
                  : " Professional Financial Planning Solutions for Long-Term Wealthand Security"}
              </h3>
              <p className="mt-[20px] mb-[40px] sm:mt-[25px] sm:mb-[50px] lg:mt-[30px] lg:mb-[60px] para-lg text-tarnary font-normal">
                {serviceItems?.heroDescription
                  ? serviceItems?.heroDescription
                  : `
              ...
              <div className="space-y-[30px]">
                <h5 className="headingFive text-primary font-bold underline">
                  {serviceItems?.consultOfferingsTitle
                    ? serviceItems?.consultOfferingsTitle
                    : "Consult Offerings"}
                </h5>
                <ul className="space-y-5">
                  {serviceItems?.consultOfferings
                    ? serviceItems?.consultOfferings?.map((items) => {
                        return (
                          <li
                            key={items}
            ...
            <div>
              <div className="relative w-full h-[260px] sm:h-[360px] md:h-[460px] lg:h-full mt-7 md:mt-9 lg:mt-0">
                <Image
                  src={
                    serviceItems?.imgId
                      ? home2Section[serviceItems?.imgId]?.img
                      : home2Section[1].img
                  }
